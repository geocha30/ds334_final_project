...
First Map with the Original Data Set 
...
Second Map with the Predicted Data Set
...
Table with the Number of Developed and Underdeveloped, comparing the actual numbers to the ones predicted from the neural network
