...
electricity_stats <- electricity_access |>
  ...
  summarise(`mean_under_elec` = mean(`Electricity Access`),
            `sd_under_elec` = sd(`Electricity Access`))
```
...
agriculture_land_stats <- agricultural_land |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_agr_land` = mean(`Agricultural Land`),
            `sd_agr_land` = sd(`Agricultural Land`))
```
...
freshwater_withdrawals_stats <- freshwater_withdrawals |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_water_withd` = mean(`Freshwater Withdrawals`),
            `sd_water_withd` = sd(`Freshwater Withdrawals`))
```
...
sanitation_stats <- sanitation |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_sanit` = mean(`Sanitation`),
            `sd_sanit` = sd(`Sanitation`))
```
...
broad_money_stats <- broad_money |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_broad` = mean(`Broad Money`),
            `sd_broad` = sd(`Broad Money`))
```
...
agriculture_employment_stats <- agriculture_employment |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_empl_agr` = mean(`Employment in Agriculture`),
            `sd_empl_agr` = sd(`Employment in Agriculture`))
```
...
fertility_rate_stats <- fertility_rate |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_fert_rate` = mean(`Fertility Rate`),
            `sd_fert_rate` = sd(`Fertility Rate`))
```
...
gov_debt_stats <- gov_debt |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_gov_debt` = mean(`Government Debt`),
            `sd_gov_debt` = sd(`Government Debt`))
```
...
internet_stats <- internet |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_inter` = mean(`Internet`),
            `sd_inter` = sd(`Internet`))
```
...
birth_life_exp_stats <- birth_life_exp |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_life_exp` = mean(`Life Expectancy at Birth`),
            `sd_life_exp` = sd(`Life Expectancy at Birth`))
```
...
school_enrol_stats <- school_enrol |>
  ...
  group_by(`Country Name`) |>
  summarise(`mean_school_enr` = mean(`School Enrollment`),
            `sd_school_enr` = sd(`School Enrollment`))
```
...
```{r}
model_glm <- glm(data = full_stats_df, Underdeveloped~., family = "binomial")
model_glm
```
...
grid <- full_stats_df |>
  ...
  sd_agr_land = seq_range(c(0.00000, 10.17398), n = 3), 
  mean_empl_agr = seq_range(c(0.3385729, 89.4033177),n = 3),
  sd_empl_agr = seq_range(c(0.1398931, 14.9939666), n = 3),
  mean_atms = seq_range(c(0.1511111, 257.4717647), n = 3),
  sd_atms = seq_range(c(0.03962323, 92.97259482), n = 3),
  mean_life_exp = seq_range(c(46.14012, 82.19024), n = 3),
  sd_life_exp = seq_range(c(0.6238412, 12.0160531), n = 3),
  mean_broad = seq_range(c(9.905998, 281.061859), n = 3),
  sd_broad = seq_range(c(1.55058, 90.20813), n = 3),
  mean_under_elec = seq_range(c(4.210244, 100.000000), n = 3), 
  sd_under_elec = seq_range(c(0.00000, 33.03473), n = 3),
  mean_fert_rate = seq_range(c(1.104000, 7.502063), n = 3),
  sd_fert_rate = seq_range(c(0.03911521, 1.47264562), n = 3), 
  mean_water_withd = seq_range(c(0.02026736, 6495.832000), n = 3), 
  sd_water_withd = seq_range(c(0.0000, 992.7009), n = 3), 
  mean_gov_debt = seq_range(c(1.845685, 179.297695), n = 3), 
  sd_gov_debt = seq_range(c(0.3324068, 76.5222152), n = 3), 
  mean_inter = seq_range(c(0.00000, 65.78868), n = 3), 
  sd_inter = seq_range(c(0.00000, 40.63393), n = 3), 
  mean_pov = seq_range(c(17.7, 82.3), n = 3), 
  sd_pov = seq_range(c(0.6363961, 12.8358130), n = 3), 
  mean_precip = seq_range(c(18.100, 3219.742), n = 3), 
  sd_precip = seq_range(c(0.0000, 112.7921), n = 3),
  mean_sanit = seq_range(c(6.029739, 100.000000), n = 3), 
  sd_sanit = seq_range(c(0.00000, 22.67257), n = 3), 
  mean_school_enr = seq_range(c(0.537100, 1.083108), n = 3), 
  sd_school_enr = seq_range(c(0.01827953, 0.19308682), n = 3), 
  Underdeveloped = c("0", "1")
  ) 
grid
```
...
ggplot(data = aug_surv, mapping = aes(x = Age, 
                                      y = .predprob
                                      ))+
  geom_line(aes(color = Sex), linewidth = 1.7)+
  facet_wrap(~Pclass)+
  geom_rug(data = rug_survive, sides="t", alpha = 0.5, 
           aes(y = Survived))+
  geom_rug(data = rug_died, sides="b", alpha = 0.5, 
           aes(y = Survived))+
