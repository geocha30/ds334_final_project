...
grid <- full_stats_df |>
  data_grid(
    ...
    mean_sanit = median_sanit, 
    mean_inter = median_internet,
    mean_pop_growth =seq_range(c(-2.022998, 4.438928), n = 5),
    mean_prim_school = median_primary_school, 
    mean_total_unempl = median_total_unempl
  )
...
grid <- full_stats_df |>
  data_grid(
    ...
    mean_elec_access = median_elec_access,
    mean_fert_rate = seq_range(c(-1.308798, 2.850897), n = 20),
    mean_sanit = median_sanit, 
    mean_inter = seq_range(c(-1.511381, 2.405766), n = 20),
    mean_pop_growth =seq_range(c(-2.221712, 3.779502), n = 5),
    mean_prim_school = median_primary_school, 
    mean_total_unempl = median_total_unempl
  )
